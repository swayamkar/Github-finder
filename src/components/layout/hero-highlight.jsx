...
export const HeroHighlight = ({ children, className, containerClassName }) => {
  ...
  return (
    <div
      className={cn(
        "relative min-h-screen w-full flex flex-col py-20 px-5 bg-white justify-center sm:justify-start group",
        containerClassName
      )}
    ...
    >
      ...
      <div className={cn("relative z-20 sm:mt-20", className)}>{children}</div>
    </div>
  );
};
